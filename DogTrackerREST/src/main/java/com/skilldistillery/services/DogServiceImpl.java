...
public class DogServiceImpl implements DogService {
	...
	@Override
	public List<Dog> findDogsByKeyword(String keyword) {
		keyword= "%" + keyword+ "%";
		return repo.findByNameLikeOrBreedLike(keyword, keyword);
		
	}
	@Override
	public List<Dog> findDogsByWeight(Integer min, Integer max) {
		
		return repo.findByWeightBetween(min, max);
	}
}